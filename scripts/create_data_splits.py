...
def get_args(): 
    ...
    parser.add_argument("--min_num_drugs_per_cell_line", type=int, default=5,
                        help="test/val cell line inclusion criteria")
    
    parser.add_argument("--min_num_obs_per_cell_line", type=int, default=5,
                        help="test/val cell line inclusion criteria")
...
if __name__ == '__main__': 
    ...
    sig_ids = torch.load(args.proc + '/sig_ids.pt')
