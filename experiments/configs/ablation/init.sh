...
EXCLUCDE_BLOOD_LINES='--exclude_blood_lines'                 # exclude blood cell lines from the data 
...
SEARCHSPACE="init_ablation"             # options: 'large', 'small' ... (number of hyper-parameters to test)
